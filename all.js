  ...
  const states = 
    Object .entries (groupBy (s => s.state) (allDays)) .map (([state, days]) => [state, {
      cases: {
        ...
        oneDay: days .slice (-1) [0] .cases - (days .slice (-2, -1) [0] || {cases: 0}) .cases,
        sevenDays: days.slice (-1) [0] .cases - (days .slice (-8, -7) [0] || {cases: 0}).cases,
        thirtyDays: days.slice (-1) [0] .cases - (days .slice (-31, -1) [0] || {cases: 0}) .cases,
      ...
      deaths: {
        ...
        oneDay: days .slice (-1) [0] .deaths - (days .slice (-2, -1) [0] || {deaths: 0}) .deaths,
        sevenDays: days.slice (-1) [0] .deaths - (days .slice (-8, -7) [0] || {deaths: 0}) .deaths,
        thirtyDays: days.slice (-1) [0] .deaths - (days .slice (-31, -1) [0] || {deaths: 0}) .deaths,
...
const populations = ((pops) => ({
  ...
  ...({"American Samoa": 55312, Guam: 168485, "Northern Mariana Islands": 56882, "Virgin Islands": 106977})
})
